...
inline int toLower(UChar* src, int len, UChar* destIfNeeded)
{
    return len;
}
...
inline int toUpper(UChar* src, int len, UChar* destIfNeeded)
{
    return len;
}
...
{
    return (c & 0xffff0000) == 0 && category(c) == Other_Format;
}
